...
export default function TodoForm() {
  ...
  const onNewQuote = evt => {
    ...
    const newQuote = { ...state, apocryphal:false, id:getNextId() }
    /*
    An alternate solution would be to remove newQuote above and replace newQuote below with (state)
    And then continue in quotesSlice
    */
